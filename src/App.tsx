          ...
          {view === 'books' ? (
            ...
            >
              <div className="bg-brand-card p-12 rounded-3xl border border-black/5 card-shadow text-center">
                ...
                <h2 className="text-2xl font-bold mb-2">Topics View</h2>
                <p className="text-brand-muted max-w-md mx-auto">
                  This view will allow you to browse resources by themes like "Justice", "Liberation", "Queer Theology", and more.
                </p>
                <button 
                  onClick={() => setView('books')}
                  className="mt-6 px-6 py-2 bg-black text-white rounded-full text-sm font-semibold"
                >
                  Back to Books
                </button>
              </div>
